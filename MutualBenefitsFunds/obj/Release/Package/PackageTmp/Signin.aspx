<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signin.aspx.cs" Inherits="MutualBenefitsFunds.Signin" %>
        ...
        <div class="container header-in">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <a href="Index.aspx" class="btn btn-sm border-radius-30 margin-tb-15px text-white background-second-color  box-shadow float-right padding-lr-20px margin-left-30px">
            ...
            <div class="form-output">
                <div>
                    ...
                    <div class="remember">
                        ...
                        <a href="forgotPassword.aspx" class="forgot">Forgot my Password?</a>
                    </div>

                      <div id="errordis" runat="server"></div>                   
                     <asp:Button ID="Lsubmit" CssClass="btn btn-sm border-radius-30 margin-tb-15px text-white background-second-color  box-shadow float-right padding-lr-20px margin-left-30px"  runat="server" Text="Sign in" OnClick="btnSign_Click" />
                    
                    


                    <p>Don't you have an account? <a href="VeriCode.aspx">Register Now!</a> </p>
                </div>
            </div>
        </div>
        <!--======= // log_in_page =======-->
